...
<html>
        ...
        <script type="text/javascript">
            function verificarblancos(formu){
                if(formu.t_Nombre.value=="" && formu.t_Apellido.value=="" && formu.t_Codigo.value=="")
                    ...
                    Form1.method="post";
                    Form1.action="gestionusuario1.jsp?Nombre=" +formu.t_Nombre.value +"&Apellido="+formu.t_Apellido.value+"&Codigo="+formu.t_Codigo.value;
                }
            }
    ...
    <body BGCOLOR=#FFFFFF LEFTMARGIN=0 TOPMARGIN=0 MARGINWIDTH=0 MARGINHEIGHT=0>
        ...
        <div id="wb_Form1" style="position:absolute;background-color:#F0F0F0;left:35%;top:50%;width:461px;height:189px;">
            <form name="Form1" enctype="text/plain" id="Formulario1">
    ...
    <div style ="position:absolute;left:37%;top:37%;width:600px;height:90px;z-index:2 " >
        <span style="color:#1E4D80;font-family:Arial-Black;font-size:26px;"> GESTION DE USUARIO - BUSQUEDA </span> 
    </div>
