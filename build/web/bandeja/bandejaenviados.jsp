<%@page import="com.Tramite.Model.DocumentoSalida"%>
 ...
 <!--Estilos de el modal--->
    ...
    <body BGCOLOR=#FFFFFF LEFTMARGIN=0 TOPMARGIN=0 MARGINWIDTH=0 MARGINHEIGHT=0>
       <%-- ventana emergente  --%>
        ...
        <div style ="position:absolute;left:10%;top:40%;width:700px;height:10px;z-index:2 " >
        ...
        <div style ="position:absolute;left:77%;top:53%;width:600px;height:63px;z-index:2 " >
            <span style="color:#1E4D80;font-family:Arial-Black;font-size:16px;"> 
                BANDEJA DOCUMENTOS ENVIADOS

            </span> 

        </div>
        <div style ="position:absolute;left:25%;top:57%;width:600px;height:37px;z-index:2 " >
            <span style="color:#1E4D80;font-family:Arial-Black;font-size:16px;"> 
        ...
        <div style ="width:800px;height:200px;position:absolute; top:57%;left:25%">      
            <table cellpadding="0" cellspacing="0" border="0" id="table" class="sortable "style="cursor:pointer;" >			
                <thead>
                    <tr >				
                        <th class="nosort"  style ="width:150px; height:10px;  text-align:center;" ><h3>Asunto</h3></th>
                        <th style ="width:50px;text-align:center; height:10px;  "><h3>Codigo</h3></th>
                        <th style ="width:250px;text-align:center;"><h3>Usuario Envio</h3></th>
                        <th style ="width:120px;text-align:center;"><h3>Area Destino</h3></th>
                ...
                <tbody >
                    <%
                        ...
                        DocumentoSalida documentos = new DocumentoSalida();
                        ArrayList<DocumentoSalida> respuesta = documentos.conseguirConsulta(nuevo);

                        for (DocumentoSalida d : respuesta) {
                            out.println("<tr>" + d + "</tr>");
                        }
