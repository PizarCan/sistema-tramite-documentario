    ...
    <body BGCOLOR=#FFFFFF LEFTMARGIN=0 TOPMARGIN=0 MARGINWIDTH=0 MARGINHEIGHT=0>
        ...
        <div style ="position:absolute;left:77%;top:53%;width:600px;height:63px;z-index:2 " >
            <span style="color:#1E4D80;font-family:Arial-Black;font-size:16px;"> 
                DOCUMENTOS INICIADOS EN EL AREA
        ...
        <div id="NavigationBar1" style="position:absolute;left:10%;top:58% ;width:158px;height:200px;z-index:2">
            <ul class="navbar">
            ...
            <table cellpadding="0" cellspacing="0" border="0" id="table" class="sortable" style="cursor:pointer;" >			
                <thead>
                    <tr >				
                        ...
                        <th style ="width:250px;text-align:center;"><h3>Asunto</h3></th>
                        <th style ="width:250px;text-align:center;"><h3>Remitente</h3></th>
                        <th style ="width:150px;text-align:center;"><h3>Area</h3></th>
                ...
                <tbody>
                    <%
                        ...
                        ArrayList<DocumentoEntrada> respuesta = documentos.conseguirConsultaIniciados(nuevo);
