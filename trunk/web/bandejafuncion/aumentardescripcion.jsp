...
<html><head>
        ...
        <title>Aumentar Descripcion</title>
...
<div style ="position:absolute;left:68%;top:53%;width:1000px;height:40px;z-index:2 " >
            <span style="color:#1E4D80;font-family:Arial-Black;font-size:20px;"> AUMENTAR DESCRIPCION : Elija Documento</span> 

</div>

<div style ="width:800px;height:200px;position:absolute; top:57%;left:25%; cursor:pointer;">  
    
    
            <table cellpadding="0" cellspacing="0" border="0" id="table" class="sortable" >			
                <thead>
                    <tr >				
                            <th class="nosort" style ="width:15px; text-align:center;" ><h3>Respondido</h3></th>
                        <th style ="width:50px;text-align:center; "><h3>Codigo</h3></th>
                        <th style ="width:150px;text-align:center;"><h3>Asunto</h3></th>
                        <th style ="width:200px;text-align:center;"><h3>Ult Usuario</h3></th>
                        <th style ="width:120px;text-align:center;"><h3>Area Usuario</h3></th>
                        <th style ="width:60px;text-align:center;"><h3>Estado</h3></th>
                        <th style ="width:60px;text-align:center;"><h3>Fecha</h3></th>
                    </tr>
                </thead>
                <tbody >
                    <%
...
//                        String nombre1 = (String) request.getAttribute("nombreUsuario");
  //                      String apellido1 = (String) request.getAttribute("apellidoUsuario");
                        ...
                        for (DocumentoEntrada d : respuesta) {
                            ...
                            out.println(" SIN DOCUMENTOS RECEPCIONADOS ");
