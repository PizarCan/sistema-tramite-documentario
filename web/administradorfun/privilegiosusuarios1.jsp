...
<html>
        ...
        <script type="text/javascript">
            ...
            function modificar(){
                ...
                if(filaSeleccionada==-1)
                    ...
                    Form2.method="post";
                    Form2.action="privilegiosusuarios2.jsp?Codigo="+cod;
    ...
    <body BGCOLOR=#FFFFFF LEFTMARGIN=0 TOPMARGIN=0 MARGINWIDTH=0 MARGINHEIGHT=0>
       ...
       <form name="Form2" id="c_FormRegistro">
            <input id="c_Button" name="b_modificar" value="Modificar" type="button" onclick="modificar();" style="position: absolute; left: 45%; top: 80%; width: 96px; height: 25px; font-family: Arial; font-size: 13px; z-index: 9;">
       </form> 
